...
- Criar um programa: Nome: ZR<iniciais>_SBBATCH_INPUT 
    ...
    * Regra: 
          ...
          - Se a unidade de mediada do material estiver contido na parametrização, então gravar o campo com a concatenação de nome do material + unidade de medida, atualizar via Batch Input MM02. 
